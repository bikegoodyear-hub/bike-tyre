...
export interface Config {
  ...
  globals: {
    ...
    'shop-configuration': ShopConfiguration;
  };
  globalsSelect: {
    ...
    'shop-configuration': ShopConfigurationSelect<false> | ShopConfigurationSelect<true>;
  };
  locale: 'en' | 'zh';
  user:
    | (Administrator & {
...
export interface Product {
  ...
  attributeValues: {
    ...
    sele?:
      ...
      | boolean
      | null;
    variationuse?: boolean | null;
    specificationuse?: boolean | null;
    id?: string | null;
  }[];
  /**
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "shop-configuration".
 */
export interface ShopConfiguration {
  ...
  ShopSettings?: {
    shops?:
      | {
          ...
          sellingLocations?: ('all-countries' | 'expected-countries' | 'specific-countries') | null;
          'specific-countries'?: ('UK' | 'IN' | 'US') | null;
          'expected-countries'?: ('UK' | 'IN' | 'US') | null;
          shippingLocations?: ('ALL' | 'SPECIFIC')[] | null;
          currency: {
            /**
             * First currency will be used as default
             */
            availableCurrencies: ('USD' | 'EUR' | 'GBP' | 'INR')[];
            currencyFormat?: {
              symbolPosition?: ('left' | 'right') | null;
  ...
  Shipping: {
    shippingZones: {
      ...
      countries: ('UK' | 'IN' | 'US')[];
      methods: {
        method: 'flat_rate' | 'free_shipping' | 'local_pickup' | 'carrier';
        flatRate?: {
          title?: string | null;
          cost: number;
        ...
        carrier?: {
          carrierType: 'usps' | 'fedex' | 'ups' | 'dhl';
          title?: string | null;
          enabled?: boolean | null;
          testMode?: boolean | null;
          usps?: {
            userId: string;
            serviceTypes?: ('priority' | 'first_class' | 'express')[] | null;
          };
          fedex?: {
            accountNumber: string;
            apiKey: string;
            apiSecret: string;
            services?: ('ground' | '2day' | 'overnight')[] | null;
          };
        };
        id?: string | null;
      }[];
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "shop-configuration_select".
 */
export interface ShopConfigurationSelect<T extends boolean = true> {
  ShopSettings?:
    | T
    | {
        shops?:
          ...
          | {
              ...
              sellingLocations?: T;
              'specific-countries'?: T;
              'expected-countries'?: T;
              shippingLocations?: T;
              currency?:
                | T
                | {
